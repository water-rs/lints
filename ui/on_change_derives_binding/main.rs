...
fn main() {
    ...
    let _ = text("a").on_change(&flag, move |v| other.set(!v));
    ...
    let flag: Binding<bool> = binding(false);
    let _ = text("a").on_change(&count, move |_v| flag.set(true));
